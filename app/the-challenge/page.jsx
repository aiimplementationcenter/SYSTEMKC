export const metadata = {
  ...
  description: 'Live 1-on-1 business growth training â€” 60 days, $20,000 in new revenue guaranteed or we work for free. Six pillars: offers, marketing, sales, speed-to-lead, referrals, and automation.',
};
    ...
    <main>
      ...
      <section className="nat-hero nat-hero--gradient">
        <div className="wrap">
          ...
          <p className="nat-lede">This isn't a course with homework. It's live sessions with you and your management team â€” where we build your growth playbook, redesign your offer, and install the systems that run it automatically. Start to finish, in 60 days.</p>
          <div className="actions" style={{marginTop: '32px', display: 'flex', flexWrap: 'wrap', gap: '12px', alignItems: 'center'}}>
            ...
            <a className="btn btn--ghost" href="#curriculum">Scroll to see what's included â†“</a>
          </div>
        ...
        <div className="wrap">
          ...
          <div className="three-col" style={{marginTop: '44px'}}>
            ...
            <div className="three-card">
              ...
              <p style={{marginTop: '16px', fontWeight: '700', color: 'var(--ink)', fontSize: '17px'}}>We build it together â€” you leave each session with something done</p>
            </div>
          </div>
          <p style={{marginTop: '36px', fontSize: '18px', color: 'var(--text)', lineHeight: '1.65', maxWidth: '64ch'}}>Jason works directly with you and your management team â€” not a junior coach, not a call center. Every session is tailored to your specific business, your specific numbers, and your specific growth gaps.</p>
        </div>
      </section>
        ...
        <div className="wrap">
          ...
          <div className="process-steps" style={{marginTop: '48px'}}>
            ...
            <div className="proc-step">
              ...
              <p>We start where the money is: your pricing, your offer, and where revenue is currently leaking. We audit what you charge vs. what the market will bear, redesign your offer for maximum clarity and conversion, and identify the 2â€“3 highest-ROI changes you can make this week. Most clients find $5,000â€“$15,000 in additional annual revenue just from the pricing conversation alone.</p>
            </div>

            <div className="proc-step">
              <div className="proc-month" style={{color: 'var(--blue)'}}>Pillar 2</div>
              <h3>Marketing &amp; Lead Gen</h3>
              <p>We map every channel where your customers actually exist â€” Google, Facebook, Instagram, TikTok, Nextdoor, email, your existing database. You'll know exactly what to post, where to post it, and how to measure whether it's working. We also show you how to create content that attracts local customers without spending hours on it.</p>
            </div>

            <div className="proc-step">
              <div className="proc-month" style={{color: 'var(--blue)'}}>Pillar 3</div>
              <h3>Sales &amp; Conversion</h3>
              <p>What you say when a lead comes in, how you quote, how you handle objections â€” this is where most service businesses lose deals they should win. We redesign your pitch, your follow-up sequence, and your quote process so leads that used to die get closed instead.</p>
            </div>

            <div className="proc-step">
              <div className="proc-month" style={{color: 'var(--blue)'}}>Pillar 4</div>
              <h3>Speed-to-Lead &amp; Follow-Up</h3>
              <p>78% of buyers go with whoever responds first. We build the response system that makes sure you're always first â€” automated acknowledgment within seconds, follow-up for days and weeks, and the conversion sequence that closes leads who went quiet. This is usually the fastest-payback piece of the whole Sprint.</p>
            </div>

            <div className="proc-step">
              <div className="proc-month" style={{color: 'var(--blue)'}}>Pillar 5</div>
              <h3>Referral &amp; Review Systems</h3>
              <p>Your existing customers are your highest-converting lead source â€” and most businesses never ask them properly. We design and install a referral program and review engine that run automatically: after every completed job, a trigger fires that asks for the review and plants the referral seed. No one has to remember to ask.</p>
            </div>

            <div className="proc-step">
              <div className="proc-month" style={{color: 'var(--blue)'}}>Pillar 6</div>
              <h3>Operations &amp; Automation</h3>
              <p>The final pillar executes everything above: missed-call text-back, lead nurture sequences, appointment reminders, rebooking campaigns, and the SOPs that let your team run the business without you narrating every step. Automation without strategy is busywork â€” but automation after the strategy is how you scale.</p>
            </div>
      ...
      <section className="section">
        <div className="wrap">
          ...
          <div className="process-steps" style={{marginTop: '48px'}}>
            ...
            <div className="proc-step">
              <div className="proc-month" style={{color: 'var(--blue)'}}>Week 1â€“2</div>
            ...
            <div className="proc-step">
              <div className="proc-month" style={{color: 'var(--blue)'}}>Week 3â€“4</div>
            ...
            <div className="proc-step">
              <div className="proc-month" style={{color: 'var(--blue)'}}>Week 5â€“6</div>
              <h3>Sales process and speed-to-lead system</h3>
              <p>Follow-up sequences built and active. Quote process redesigned.</p>
            </div>

            <div className="proc-step">
              <div className="proc-month" style={{color: 'var(--blue)'}}>Week 7â€“8</div>
              <h3>Referral and review systems installed</h3>
              <p>Your existing customers become your best lead source â€” running automatically after every job.</p>
            </div>

            <div className="proc-step">
              <div className="proc-month" style={{color: 'var(--blue)'}}>Week 9â€“10</div>
              <h3>Full automation install</h3>
              <p>Every workflow, SOP, and automation built, tested, and live.</p>
            </div>

            <div className="proc-step">
              <div className="proc-month" style={{color: 'var(--blue)'}}>Week 11â€“12 (Buffer)</div>
      ...
      <section className="section section--alt">
        <div className="wrap-narrow">
          ...
          <p style={{marginTop: '20px', fontSize: '16px', color: 'var(--muted)', lineHeight: '1.8'}}>HVAC Â· Plumbing Â· Roofing Â· Real estate Â· Dental Â· Medical Â· Salons Â· Nail salons Â· Barber shops Â· Spas Â· Massage therapists Â· Hair stylists Â· Restaurants Â· Landscapers Â· Pest control Â· Law firms Â· Auto repair Â· Gyms Â· Cleaning services</p>
        </div>
      </section>
      ...
      <section className="section">
        <div className="wrap-narrow">
          ...
          <h2 style={{marginTop: '14px'}}>Jason Dillon â€” 20-year operator.</h2>
          <blockquote className="op-quote">
            "I still own and operate a multi-location service company. Every strategy I teach, I use in my own business today. I built the Sprint because the kind of help I needed when I was scaling didn't exist â€” someone who would walk into my operation, look at my actual numbers, and tell me what to fix first. That's exactly what the Sprint is."
          </blockquote>
        </div>
      </section>

      {/* â”€â”€ FINAL CTA STRIP â”€â”€ */}
      <section className="cta-strip">
        <div className="wrap inner">
          <h2>3 of 5 spots currently open.</h2>
          <p className="sub">Apply for a free fit call. We look at your business and tell you exactly what the Sprint would produce for you â€” before you commit to anything.</p>
          <div className="actions">
            <a className="btn btn--invert" href="/apply/">Apply Now <span className="arrow">â†’</span></a>
            <a className="btn btn--ghost-invert" href="/contact/">Or just reach out â†’</a>
          </div>
        </div>
      </section>

          ...
          <div className="process-steps" style={{marginTop: '48px'}}>
            ...
            <div className="proc-step">
              ...
              <div>
                ...
                <p style={{marginTop: '12px', fontSize: '17px', lineHeight: '1.8'}}>What you say when a lead comes in, how you quote, how you handle objections. We redesign your pitch, follow-up sequence, and quote process so leads that used to die get closed instead.</p>
              </div>
            </div>
            ...
            <div className="proc-step">
              <div className="proc-month">Pillar 6</div>
              <div>
                <h3>Operations &amp; Automation</h3>
                <p style={{marginTop: '12px', fontSize: '17px', lineHeight: '1.8'}}>The final pillar executes everything above: missed-call text-back, lead nurture sequences, appointment reminders, rebooking campaigns, and the SOPs that let your team run the business without you narrating every step. This is the last step, not the first.</p>
              </div>
            </div>

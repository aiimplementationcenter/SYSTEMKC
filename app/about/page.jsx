...
export default function Page() {
  return (
    <main>
<div className="wrap"><div className="crumbs"><a href="/">Home</a><span className="sep">Â·</span><span className="here">About</span></div></div>
  ...
  <div className="wrap">
    <div style={{display: 'grid', gridTemplateColumns: '1fr 1.4fr', gap: '64px', alignItems: 'start'}}>
      ...
      <div className="prose">
        ...
        <ul>
          <li><strong>How to build a better offer and money model</strong> â€” pricing, offer clarity, and where revenue is currently leaking.</li>
          <li><strong>How to get more customers</strong> â€” marketing, referrals, reviews, reactivation, and the channels where your buyers actually exist.</li>
          <li><strong>How to convert more leads</strong> â€” sales process, speed-to-lead, and the follow-up sequence that closes leads that used to die.</li>
          <li><strong>How to make more from each customer</strong> â€” pricing, upsells, retention, and customer lifetime value math.</li>
          <li><strong>How to build referral and review systems that run automatically</strong> â€” installed after every completed job, without anyone having to remember to ask.</li>
          <li><strong>How to run it without you</strong> â€” automations, SOPs, and documented workflows that let your team run the business without you narrating every step.</li>
        </ul>
        ...
        <ul>
          ...
          <li><strong>Yours either way.</strong> Every playbook, SOP, workflow, and automation we build belongs to you from day one. Leave any time â€” it all comes with you.</li>
          <li><strong>Month-to-month.</strong> No annual lock-ins. No proprietary black boxes. No contracts you can't exit.</li>
          <li><strong>Live, 1-on-1.</strong> This isn't a course with homework. The Sprint is live sessions with you and your team â€” built around your business, not a generic curriculum.</li>
        </ul>
        <h2>The tools we use</h2>
        <p>We start with what you already have. Before recommending anything new, we map your existing stack and find how much we can build on top of it. Where you need something new, we help you choose and configure it for your specific operation. The goal is always the right tool for your business â€” not the most impressive one.</p>
      </div>
    </div>
  </div>
</section>
...
<section className="section section--alt">
  <div className="wrap-narrow">
    ...
    <h2 style={{marginTop: '14px'}}>Marketing is a force multiplier â€” but only if what it's multiplying is solid.</h2>
    <p style={{marginTop: '20px', fontSize: '17px', lineHeight: '1.8', color: 'var(--muted)'}}>The biggest mistake local service businesses make is spending money on marketing before fixing what's underneath. If your offer is unclear, your follow-up is slow, your pricing is off, and your referral system doesn't exist â€” putting more leads into that funnel just produces more wasted opportunity at a higher cost.</p>
    <p style={{marginTop: '16px', fontSize: '17px', lineHeight: '1.8', color: 'var(--muted)'}}>Fix the model first. Then marketing stops being an expense and starts being a multiplier. A business with a strong offer, a referral engine, and an optimized pricing model can get 3â€“5Ã— the result from the same ad budget as one that hasn't done that work.</p>
  ...
  <div className="wrap-narrow">
    ...
    <div className="trust-grid" style={{marginTop: '36px'}}>
      {[
        ...
        ['20 years operating', 'Jason still owns and operates a multi-location service business. This isn\'t theory â€” it\'s a tested playbook.'],
...
<section className="cta-strip">
  <div className="wrap inner">
    ...
    <p className="sub">First conversation is free. We look at your business and tell you exactly where the highest-leverage growth move is â€” before you spend anything.</p>

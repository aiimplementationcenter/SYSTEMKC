...
export const metadata = {
  title: 'S.Y.S.T.E.M. KC &mdash; Add $20,000 in New Revenue in 60 Days. Guaranteed.',
  description: 'Live 1-on-1 business growth training for local service businesses. We teach offers, marketing, sales, speed-to-lead, referrals, and automation &mdash; start to finish in 60 days.',
};
    ...
    <main>
      ...
      <section className="nat-hero nat-hero--gradient">
        <div className="wrap">
          ...
          <p className="nat-lede">Fire your agency. We teach local service business owners live, 1-on-1 &mdash; how to fix their money model, explode their customer base, and build a business that doesn't fall apart when they step away. Not a course. Not homework. Live sessions with you and your team.</p>
          <p className="nat-sub">You'll add $20,000 in new revenue in 60 days &mdash; or I work for free until you do.</p>
          <div className="actions" style={{marginTop: '32px', display: 'flex', flexWrap: 'wrap', gap: '12px', alignItems: 'center'}}>
            <a className="btn btn--primary" href="/apply/">Apply Now <span className="arrow">&rarr;</span></a>
      ...
      <section className="section">
        <div className="wrap">
          ...
          <div className="stat-wall" style={{marginTop: '40px'}}>
            <div className="stat-cell"><div className="stat-num">62%</div><div className="stat-desc">of calls to local service businesses go unanswered &mdash; each one a job that went somewhere else<sup>1</sup></div></div>
            <div className="stat-cell"><div className="stat-num">&lt;5 min</div><div className="stat-desc">response time makes you 21&times; more likely to close &mdash; most owners don't have a system for this<sup>2</sup></div></div>
            <div className="stat-cell"><div className="stat-num">78%</div><div className="stat-desc">of buyers choose whoever responds first &mdash; not who does the best work or has the best reviews<sup>3</sup></div></div>
          ...
          <div className="stat-wall" style={{marginTop: '24px', borderTop: '1px solid var(--rule)', paddingTop: '24px'}}>
            <div className="stat-cell"><div className="stat-num">5%</div><div className="stat-desc">more customer retention increases profits by 25&mdash;95% &mdash; retention is the most underused growth lever in service businesses<sup>5</sup></div></div>
            <div className="stat-cell"><div className="stat-num">200%</div><div className="stat-desc">more lifetime spend from referred customers vs. non-referred &mdash; your referral program is your highest-ROI marketing channel<sup>6</sup></div></div>
            <div className="stat-cell"><div className="stat-num">3&mdash;5&times;</div><div className="stat-desc">higher ad conversion when your offer is clear and differentiated &mdash; fixing the offer makes every marketing dollar go further<sup>7</sup></div></div>
            <div className="stat-cell"><div className="stat-num">5&mdash;9%</div><div className="stat-desc">revenue increase per additional star on Google &mdash; reviews aren't a vanity metric, they're a revenue driver<sup>8</sup></div></div>
          </div>
          <p className="stat-sources">Sources: <sup>1</sup>Invoca 2023 &middot; <sup>2</sup>Harvard Business Review &middot; <sup>3</sup>Velocify &middot; <sup>4</sup>Clutch &middot; <sup>5</sup>Bain &amp; Company &middot; <sup>6</sup>McKinsey &middot; <sup>7</sup>CXL Institute &middot; <sup>8</sup>Harvard Business School</p>
        </div>
      </section>
      ...
      <section className="section section--alt">
        <div className="wrap">
          ...
          <p className="lede" style={{marginTop: '18px', maxWidth: '60ch'}}>Most owners buy software and hope it helps. We teach the actual business model &mdash; then add tools that execute it automatically.</p>
          <div className="three-col" style={{marginTop: '44px'}}>
            <div className="three-card">
              <div className="three-num">PILLAR 01</div>
              <h3>Offers &amp; Money Model</h3>
              <p>We audit exactly how your business makes money &mdash; pricing, margins, offer clarity, what you're charging vs. what the market will pay. This is where most growth is hiding.</p>
            </div>
            <div className="three-card">
              <div className="three-num">PILLAR 02</div>
              <h3>Marketing &amp; Lead Gen</h3>
              <p>Google visibility, local SEO, Facebook, Instagram, TikTok, Nextdoor &mdash; we map where your customers actually are and how to reach them without guessing or overspending.</p>
            </div>
            <div className="three-card">
              <div className="three-num">PILLAR 03</div>
              <h3>Sales &amp; Conversion</h3>
              <p>What you say, how you quote, what your offer looks like. A clearer offer converts 3&mdash;5&times; better than a vague one. We redesign the pitch and the process.</p>
            </div>
          </div>
          <div className="three-col" style={{marginTop: '24px'}}>
            <div className="three-card">
              ...
              <p>78% of buyers go with whoever responds first. We build the response and follow-up system that means you're always first &mdash; even at 2am on a Tuesday.</p>
            </div>
            <div className="three-card">
            ...
            <div className="three-card">
              ...
              <p>Once the strategy is built, we install the tools that execute it &mdash; automations, SOPs, and workflows your team can run without you narrating every step.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section">
        <div className="wrap">
          ...
          <p style={{marginTop: '24px', padding: '16px 20px', background: 'var(--paper-2)', borderRadius: '8px', color: 'var(--muted)', fontSize: '15px', lineHeight: '1.7'}}>
            Also: restaurants, landscapers, pest control, insurance agents, gyms, law firms, veterinarians, auto repair, cleaning services &mdash; <strong style={{color: 'var(--text)'}}>if you sell a local service, the playbook works.</strong> <a href="/contact/" style={{color: 'var(--c-e)', fontWeight: '600'}}>Ask us about your industry &rarr;</a>
          </p>
        </div>
      </section>
        ...
        <div className="wrap">
          ...
          <div className="offer-grid">
            <div className="offer-card offer-card--featured">
              ...
              <p style={{marginTop: '12px', fontSize: '14px', color: 'var(--green)', fontFamily: 'var(--mono)', fontWeight: '700'}}>About the cost of one month with an agency &mdash; one time.</p>
            ...
            <div className="offer-card">
              <h3>Done For You</h3>
              <p>Prefer to hand it off? Our team builds and installs your full growth system &mdash; strategy, SOPs, and automations &mdash; then hands it off running. You approve decisions. We do the work.</p>
              <div style={{marginTop: '20px'}}>
                <a className="btn btn--ghost" href="/done-for-you/">Learn more &rarr;</a>
              </div>
            </div>
            <div className="offer-card">
              <h3>Not sure where to start?</h3>
              <p>Book a free 20-minute call. We look at your business and tell you exactly where the highest-leverage growth move is &mdash; before you spend anything.</p>
              <div style={{marginTop: '20px'}}>
                <a className="btn btn--ghost" href="/contact/">Book a free call &rarr;</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="section section--alt">
        <div className="wrap-narrow">
          ...
          <blockquote className="op-quote">
            "I've spent 20 years building businesses &mdash; and I still own and operate a multi-location service company across the Midwest. Every growth strategy I teach, I use. Every system I recommend, I've tested. I'm not a consultant who figured this out in a classroom."
          </blockquote>
          <p style={{marginTop: '24px', color: 'var(--muted)', fontSize: '17px', lineHeight: '1.7'}}>S.Y.S.T.E.M. KC exists because I kept watching capable business owners grind themselves into the ground &mdash; not because they lacked work ethic, but because nobody had ever shown them the actual playbook for growing a local service business. So I wrote it.</p>
        </div>
      </section>
        ...
        <div className="wrap-narrow">
          ...
          <div className="trust-grid" style={{marginTop: '36px'}}>
            {[
              ...
              ['You own all of it', 'Every playbook, workflow, automation, and document we build is yours &mdash; you stay in control of everything.'],
      ...
      <section className="cta-strip">
        <div className="wrap inner">
          ...
          <p className="sub">Apply to work with us. First conversation is free &mdash; we look at your business and tell you exactly where the highest-leverage move is.</p>
